...
GET_PROPOSAL_VOTES_Q = lambda first, skip, snapshot_id, voter, space: gql(f"""
query {{
votes(
    first: {first},
    skip: {skip},
...
def get_previous_snapshot_round(web3: Web3, space: Optional[str] = "gauges.aurafinance.eth") -> Dict:
    """
    ...
    while True:
        ...
        for proposal in result['proposals']:
            ...
            current_timestamp = web3.eth.get_block(web3.eth.get_block_number())['timestamp']
